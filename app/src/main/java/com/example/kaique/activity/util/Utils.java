...
package com.example.kaique.activity.util;
...
public class Utils {
    ...
    private static com.example.kaique.activity.util.StatusTracker mStatusTracker = com.example.kaique.activity.util.StatusTracker.getInstance();
